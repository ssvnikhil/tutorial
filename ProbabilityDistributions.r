rnorm(10) # Displaying 10 random normal distribution numbers with mean 0, sd 1
...
dnorm(randNorm10) # Probability density of those 10 numbers
...
pnorm(randNorm10)
pnorm(c(-3,0,3)) # cumulative probability of numbers
...
# False because of positional and visualization errors

# Binomial Distribution is series of trials in two values (Yes or No)
